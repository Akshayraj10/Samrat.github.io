...
<table id="customers" style="width:30%" border="10">
  ...
  <tr>
      <td align="center"> </td>
      <td align="center"><input type="submit"  style="margin:5px  value="submit" name="submit"><input type="reset"  value="reset" name="Reset"><button><a href="index.php">Login</a></button></td>
